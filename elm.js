	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Main$viewResult, model.results)),
			_1: {ctor: '[]'}
		});
};
	...
	},
	{
		...
		_0: A2(
			_elm_lang$html$Html$img,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('imgs/meetup-logo.png'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
...
var _user$project$Main$search = function (input) {
	return {
		ctor: '::',
		_0: 'elm-la',
		_1: {
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'SearchBoxInput') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					results: _user$project$Main$search(model.searchString)
				});
		}
	});
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {searchString: a, results: b};
	});
var _user$project$Main$Search = {ctor: 'Search'};
var _user$project$Main$searchButton = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$Search),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Main$SearchBoxInput = function (a) {
	return {ctor: 'SearchBoxInput', _0: a};
};
var _user$project$Main$searchBox = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SearchBoxInput),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _user$project$Main$searchWrap = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('searchbox'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$searchButton,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$searchWrap(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$viewResults(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SearchBoxInput":["String"],"Search":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
